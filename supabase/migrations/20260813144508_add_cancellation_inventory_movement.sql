-- ============================================
-- Add Cancellation Inventory Movement
-- ============================================
--
-- Replaces the existing cancellation inventory
-- restoration function.
--
-- The function now:
-- 1. Locks the order
-- 2. Verifies it is cancelled
-- 3. Locks each product variant
-- 4. Restores tracked inventory
-- 5. Records a cancellation movement
--
-- Everything happens inside the same PostgreSQL
-- transaction.
-- ============================================
...
IS
'Restores inventory for all tracked product variants belonging to a cancelled order and records cancellation inventory movements.';